"""Runtime smoke harness for alignment coverage repair 8.5.23.4.1."""
...
def main() -> int:
    ...
    if APP_VERSION != "3.3.5.5.8.5.23.4.1":
    ...
    smoke_out = smoke_dir / f"runtime_smoke_start_stop_852341_{ts}.txt"
