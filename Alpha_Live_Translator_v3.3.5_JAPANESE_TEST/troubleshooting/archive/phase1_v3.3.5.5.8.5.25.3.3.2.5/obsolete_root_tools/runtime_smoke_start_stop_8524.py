"""Runtime smoke harness for Japanese Boundary Stabilizer 8.5.24."""
...
def main() -> int:
    ...
    smoke_out = smoke_dir / f"runtime_smoke_start_stop_8524_{ts}.txt"
    smoke_out.write_text(
        f"PASSED elapsed={elapsed:.2f}s live_alpha_protected={unchanged} boundary_not_blocking_stop=True\n",
        encoding="utf-8",
    )
    ...
    print(
        ...
        f"live_alpha_protected={unchanged} boundary_stabilizer_not_blocking_stop=True"
    )
    return 0
