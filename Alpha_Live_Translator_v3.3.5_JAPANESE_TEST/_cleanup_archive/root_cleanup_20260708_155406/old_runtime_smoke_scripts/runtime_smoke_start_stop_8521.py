"""Runtime smoke harness for Start/Stop after accuracy patch 8.5.21."""
...
def main() -> int:
    from alpha.constants import APP_VERSION, RUNTIME_EVIDENCE_PACKAGE_DISABLED, STOP_PATH_MINIMAL_MODE
    from alpha.utils.stop_finalize_worker import begin_stop_from_ui

    if APP_VERSION != "3.3.5.5.8.5.21":
    ...
    if not ok_core or not ok_ui or elapsed > 5.0:
        ...
        return 1
    print(f"PASSED elapsed={elapsed:.2f}s")
    return 0
