...
class AlphaApp(
    ...
    def _make_language_combo(self, master, plain_values, variable, changed_key):
        """Language dropdown with flag labels; variable stores plain language names."""
    ...
    def create_header_frame(self):
        ...
        self.source_combo = self._make_language_combo(
        ...
        self.target_combo = self._make_language_combo(
    ...
    def _pack_header_controls(self, mode, width):
        ...
        self.source_combo.configure(width=combo_width)
        self.target_combo.configure(width=combo_width)
